...
const Navigation: React.FC<NavigationProps> = ({ activeTab, setActiveTab, user, onLogout }) => {
  ...
  return (
    <>
      {/* Desktop Navigation - Premium Dark Theme */}
          ...
          {tabs.map((tab) => {
            ...
            return (
              ...
              >
                ...
                />
                <span
                  className={`text-[10px] font-semibold mt-1 transition-all duration-300 ${isActive ? 'text-white' : 'text-white/50'
                    }`}
                >
                  {tab.label}
                </span>
        ...
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <p className="text-white/70 mb-6">
              Are you sure you want to logout from the Staff Management System?
            </p>
